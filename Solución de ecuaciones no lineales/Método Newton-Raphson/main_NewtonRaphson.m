%Problema 1 
%Se busca la potencia de una antena cuya funciÛn  est· dada por ls ecuaciÛn:
syms x
fprintf("Problema 1 \n")
f =  x-exp(-x);
a = -2;
...
% i nos indica el n√∫mero de iteraciones
i = 3;
...
%Problema 2
%Se busca la distancia a la que da mayor seÒal una antena cuya ecuaciÛn es:
fprintf("\n\nProblema 2 \n")
f3 =  x.^2-3.*x-3;
a2 = 0;
b2 = 5;
...
% i2 nos indica el n√∫mero de iteraciones
i2 = 3;
